...
export const techIcons = {
  ...
  'PostgreSQL': <SiPostgresql className="tech-icon" title="PostgreSQL" />,
  ...
  'Linux': <FaLinux className="tech-icon" title="Linux" />,
  'POSIX': <FaPlug className="tech-icon" title="POSIX" />,
  'Sockets': <FaPlug className="tech-icon" title="Sockets" />,
